...
export function buildSongUsageMap(games: GameConfig[]) {
...
export function buildMediaTrackUsageMap(games: GameConfig[], songs: Song[]) {
...
export function isMediaTrackUsed(games: GameConfig[], songs: Song[], trackId: string) {
